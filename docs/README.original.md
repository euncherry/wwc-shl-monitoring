# 히어링루프 모니터링 시스템 — 원본 플랫폼 명세 (참고용)

> ⚠️ **이 문서는 원본(`wwc-monitoring-platform`)의 README이며, mock 기반 초기 프로토타입 기준입니다.**
> 현재 레포는 이 원본을 복사한 뒤 **데이터 레이어를 NestJS 백엔드 실연동 + MSW 목으로 교체**한 버전이라
> 회원가입·활동 로그·OTA 제어·"비밀번호 아무 값" 등 일부 기능이 **변경/제거**되었습니다.
> 최신 동작 기준은 루트 [`README.md`](../README.md), 요구사항은 [`REQUIREMENTS.md`](./REQUIREMENTS.md)를 참고하세요.

공공시설에 설치된 히어링루프 장비의 상태를 실시간으로 모니터링하고 관리하는 웹 기반 플랫폼입니다.

**원본 배포 URL** : https://wwc-monitoring-platform.vercel.app
...
![관리자 히어링루프 관리](./images/admin-hearing-loops.png)
...
![관리자 텔레코일존 관리](./images/admin-telecoil-zones.png)
...
![관리자 알림센터](./images/admin-alerts.png)
...
![관리자 활동 로그](./images/admin-activity-log.png)
...
![사용자 대시보드](./images/user-dashboard.png)
...
![사용자 히어링루프 관리](./images/user-hearing-loops.png)
...
![사용자 정보관리](./images/user-settings.png)
...
![사용자 기술 지원](./images/user-support.png)
