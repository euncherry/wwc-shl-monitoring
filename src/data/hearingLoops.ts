...
export const hearingLoops: HearingLoop[] = [
  {
    id: 'HL-0001', mac: 'A4:CF:12:6B:3A:01', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  {
    id: 'HL-0002', mac: 'A4:CF:12:6B:3A:02', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
    temperature: 36, volume: 65, firmwareVersion: 'v2.4.1', status: 'normal',
    telecoilZoneId: 'tz-01', telecoilZoneName: '서울시청',
    lastUpdated: '2025-01-20 14:28', registeredAt: '2024-06-15', alerts: [],
  },
  {
    id: 'HL-0003', mac: 'A4:CF:12:6B:3A:03', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
    temperature: 37, volume: 70, firmwareVersion: 'v2.5.0', status: 'normal',
    telecoilZoneId: 'tz-01', telecoilZoneName: '서울시청',
    lastUpdated: '2025-01-20 14:25', registeredAt: '2024-07-01', alerts: [],
  },
  {
    id: 'HL-0004', mac: 'A4:CF:12:6B:3A:04', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
    temperature: 34, volume: 68, firmwareVersion: 'v2.5.0', status: 'normal',
    telecoilZoneId: 'tz-01', telecoilZoneName: '서울시청',
    lastUpdated: '2025-01-20 14:22', registeredAt: '2025-01-08', alerts: [],
  },
  {
    id: 'HL-0010', mac: 'A4:CF:12:6B:3A:10', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  {
    id: 'HL-0011', mac: 'A4:CF:12:6B:3A:11', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  {
    id: 'HL-0012', mac: 'A4:CF:12:6B:3A:12', power: false, overTemperature: false, networkConnected: false, wifiSignal: 'DISCONNECTED',
  ...
  {
    id: 'HL-0020', mac: 'A4:CF:12:6B:3A:20', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  {
    id: 'HL-0030', mac: 'A4:CF:12:6B:3A:30', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  {
    id: 'HL-0040', mac: 'A4:CF:12:6B:3A:40', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  {
    id: 'HL-0041', mac: 'A4:CF:12:6B:3A:41', power: true, overTemperature: false, networkConnected: false, wifiSignal: 'DISCONNECTED',
  ...
  {
    id: 'HL-0050', mac: 'A4:CF:12:6B:3A:50', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  // ─── 미배정 기기 ───
  {
    id: 'HL-0101', mac: 'AA:BB:CC:DD:EE:01', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
  ...
  {
    id: 'HL-0102', mac: 'AA:BB:CC:DD:EE:02', power: true, overTemperature: false, networkConnected: true, wifiSignal: 'STRONG',
    temperature: 34, volume: 55, firmwareVersion: 'v2.4.1', status: 'normal',
    telecoilZoneId: null, telecoilZoneName: null,
    lastUpdated: '2025-01-20 11:30', registeredAt: '2025-01-12', alerts: [],
  },
  {
    id: 'HL-0103', mac: 'AA:BB:CC:DD:EE:03', power: false, overTemperature: false, networkConnected: false, wifiSignal: 'DISCONNECTED',
