...
export const hearingLoops: HearingLoop[] = [
  {
    id: 'HL-0001', mac: 'A4:CF:12:6B:3A:01', power: true, overTemperature: false, networkConnected: true,
  ...
  {
    id: 'HL-0011', mac: 'A4:CF:12:6B:3A:11', power: true, overTemperature: false, networkConnected: true,
  ...
  {
    id: 'HL-0012', mac: 'A4:CF:12:6B:3A:12', power: false, overTemperature: false, networkConnected: false,
  ...
  {
    id: 'HL-0020', mac: 'A4:CF:12:6B:3A:20', power: true, overTemperature: false, networkConnected: true,
  ...
  {
    id: 'HL-0030', mac: 'A4:CF:12:6B:3A:30', power: true, overTemperature: false, networkConnected: true,
  ...
  {
    id: 'HL-0040', mac: 'A4:CF:12:6B:3A:40', power: true, overTemperature: false, networkConnected: true,
  ...
  {
    id: 'HL-0041', mac: 'A4:CF:12:6B:3A:41', power: true, overTemperature: false, networkConnected: false,
  ...
  {
    id: 'HL-0050', mac: 'A4:CF:12:6B:3A:50', power: true, overTemperature: false, networkConnected: true,
  ...
  // ─── 미배정 기기 ───
  {
    id: 'HL-0101', mac: 'AA:BB:CC:DD:EE:01', power: true, overTemperature: false, networkConnected: true,
  ...
  {
    id: 'HL-0102', mac: 'AA:BB:CC:DD:EE:02', power: true, overTemperature: false, networkConnected: true,
    temperature: 34, volume: 55, firmwareVersion: 'v2.4.1', status: 'normal',
    telecoilZoneId: null, telecoilZoneName: null,
    lastUpdated: '2025-01-20 11:30', registeredAt: '2025-01-12', alerts: [],
  },
  {
    id: 'HL-0103', mac: 'AA:BB:CC:DD:EE:03', power: false, overTemperature: false, networkConnected: false,
